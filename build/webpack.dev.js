...
module.exports = {
    entry: {
        ...
        './sdk/dist/websdk-1.4.11': ['./sdk/index', 'webpack/hot/only-dev-server', 'webpack-dev-server/client?http://localhost:3001'],
        // './sdk/dist/websdk-1.1.2': './sdk/src/connection',
        './demo/javascript/dist/demo-1.4.11': ['./demo/javascript/src/entry', 'webpack/hot/only-dev-server', 'webpack-dev-server/client?http://localhost:3001'],
