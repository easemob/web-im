...
public class ResultChannel2Processor extends BasicProcessor {
	private static Set<String> SUCCESS = null;
	private static Set<String> FAILURE = null;
	private static Map<String, String> OTHERS = null;
	private static final Logger logger = LoggerFactory.getLogger(ResultChannel2Processor.class);
...
//			logger.info("get group msg: {}", message);
