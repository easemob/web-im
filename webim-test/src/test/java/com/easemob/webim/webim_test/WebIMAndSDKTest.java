...
public class WebIMAndSDKTest extends WebIMTestBase {
	...
	public void beforeClass() throws URISyntaxException {
		...
		commandChannel = RedisChannel.COMMAND_CHANNLE_1.getChannel();
		resultChannel = RedisChannel.RESULT_CHANNLE_1.getChannel();
...
//		driver.manage().window().maximize();
	...
	@Test(enabled = true, dependsOnMethods = { "addPrivateGroupWithMemberAddtionDisable" })
	...
	@Test(enabled = true, dependsOnMethods = { "quitPrivateGroupWithMemberAddtionDisabled" })
	...
	@Test(enabled = true, dependsOnMethods = { "addPrivateGroupWithMemberAddtionDisabledByOwner" })
	...
	@Test(enabled = true, dependsOnMethods = { "addPublicGroupWithOwnerAccept" })
	...
	@Test(enabled = true, dependsOnMethods = { "addPublicGroupWithoutOwnerAccept" })
	...
	@Test(enabled = true, dependsOnMethods = { "blockPublicGroupMsg" })
	...
	@Test(enabled = true, dependsOnMethods = { "DissolvePublicGroupWithOwnerAccept" })
	...
	@Test(enabled = true, dependsOnMethods = { "addUserIntoBlackList" })
...
//		checkChatMsg(driver, username, groupId, emoji, path);
	...
	@Test(enabled = true, dependsOnMethods = { "webimSendGroupEmojiAndSdkReceive" })
...
//		checkChatMsg(driver, username, group1, emoji, path);
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupEmojiAndWebimReceive" })
...
//		checkChatMsg(driver, username, group1, emoji, path);
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupEmojiAndWebimReceiveOffline" })
	public void webimSendGroupMsgAndSdkReceive() {
		String method = Thread.currentThread().getStackTrace()[1].getMethodName();
		String path = getScreenshotPath(method);
		super.login(driver, username, password, path, isGetBaseUrl);
		message = getRandomStr(16);
		logger.info("select group: {} to send message: {}", group2, message);
		WebElement ele = findSpecialGroup(driver, groupId2, path);
		String groupId = ele.getAttribute("id");
		logger.info("find text area for send message");
		String xpath = "//textarea[@id='talkInputId']";
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupMsgAndWebimReceive" })
	...
	// send/receive file
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupMsgAndWebimReceiveOffline" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupFileAndWebimReceive" })
	...
	// send/receive image
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupFileAndWebimReceiveOffline" })
	...
	@Test(enabled = true, dependsOnMethods = { "webimSendGroupImageAndSdkReceive" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupImageAndWebimReceive" })
	...
	// send/receive audio
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupImageAndWebimReceiveOffline" })
	...
	@Test(enabled = true, dependsOnMethods = { "webimSendGroupAudioAndSdkReceive" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupAudioAndWebimReceive" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupAudioAndWebimReceiveOffline" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupLocationAndWebimReceive" })
...
//	@Test(enabled = true, dependsOnMethods = { "sdkSendGroupLocationAndWebimReceiveOffline" })
...
//	}
	...
	@SuppressWarnings({ "static-access" })
	@Test(enabled = true, dependsOnMethods = { "webimAddFriendAndSdkReject" })
	...
	@SuppressWarnings({ "static-access" })
	@Test(enabled = true, dependsOnMethods = { "deleteFriend" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkAddFriendAndWebimAccept" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendMsgAndWebimReceiveOffline" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendLocationAndWebimReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendLocationAndWebimReceiveOffline" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "webimSendFileAndSdkReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendFileAndWebimReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendFileAndWebimReceiveOffline" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "webimSendImageAndSdkReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendImageAndWebimReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendImageAndWebimReceiveOffline" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "webimSendAudioAndSdkReceive" })
	...
	@SuppressWarnings("static-access")
	@Test(enabled = true, dependsOnMethods = { "sdkSendAudioAndWebimReceive" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendAudioAndWebimReceiveOffline" })
	...
	@Test(enabled = true, dependsOnMethods = { "sdkSendChatroomMsgAndWebimReceive" })
	...
	@Test(enabled = true, dependsOnMethods = { "addFriendIntoBlackList" })
	...
	private void setGroupIdMsg(String subject) {
		...
		map.put("groupSubject", subject);
		ResultChannel1Processor.setOthers(map);
	}
